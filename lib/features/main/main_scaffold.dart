...
class _MainScaffoldState extends State<MainScaffold> with WidgetsBindingObserver {
  ...
  // TODO: Gelen arama dinleme (incoming call listener) özelliği
  // ileride ayrı bir modül olarak implement edilecek.
  // Gerekli sınıflar: CallScreen, IncomingCallScreen
  // Gerekli alanlar: _callSubscription, _showingIncomingCall

  List<Widget> _getScreens(bool isMapEnabled) {
    return [
      const DiscoverScreen(), // Unified discover with all 3 apps' features
  ...
  Widget build(BuildContext context) {
    ...
    return AnnotatedRegion<SystemUiOverlayStyle>(
      ...
      child: Scaffold(
        ...
        extendBody: false, // İçeriğin tab bar altında kalmasını engelle
        body: Column(
          children: [
